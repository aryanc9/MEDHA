...
const tutorPrompt = ai.definePrompt({
    ...
    output: { schema: z.object({
        ...
        courseContent: z.string().optional().describe("The generated course content based on the user's request. This should be a comprehensive course outline and content based on the prompt and any provided structure or source files. It should be well-formatted using Markdown with headings, lists, and bold text for clarity."),
        relatedResources: z.array(z.object({
    ...
    Based on all the provided information, generate the course content or a detailed explanation. Start with a brief, one-paragraph explanation of the topic. Then, if the request is to build a course, provide the detailed course content formatted in clear Markdown (using headings, lists, bolding, etc.).
