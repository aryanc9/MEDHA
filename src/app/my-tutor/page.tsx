...
const initialStructureGuideItems = [
    { id: 'title', icon: List, text: "Course Title", content: <Input placeholder="Enter course title" /> },
    { id: 'outcomes', icon: Target, text: "Learning Outcomes", content: <Textarea placeholder="List what students will learn..." /> },
    { id: 'size', icon: Clock, text: "Course Size", content: (
        <div className="grid grid-cols-2 gap-4">
            <Input type="number" placeholder="Number of modules" />
            <Input type="number" placeholder="Lessons per module" />
        </div>
    )},
    { id: 'outline', icon: LayoutList, text: "Course Outline" },
    { id: 'methods', icon: Lightbulb, text: "Instructional Methods", content: <Textarea placeholder="Describe teaching methods..." /> },
    { id: 'details', icon: Info, text: "Additional Details", content: <Textarea placeholder="Add any other relevant details..." /> },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-4">
                    <div className="relative">
                        ...
                        />
                        <Button className="absolute top-1/2 right-1.5 -translate-y-1/2 h-8 text-xs sm:text-sm">
                    ...
                    <Card className="bg-card/80 backdrop-blur-sm">
                        ...
                        <CardContent>
                            <div className="border-2 border-dashed border-muted-foreground/30 rounded-xl p-8 flex flex-col items-center justify-center text-center h-64">
                                ...
                                <p className="font-semibold mb-1">Drop your files here</p>
